   ...
   <section class="content pt-3">
      <div class="container-fluid">
        ...
        <div class="col-md-4 pr-0" id="addMessageTypeForm">
            ...
            <form id="createCommon" action="messageType" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
        		<div class="row m-2">
                    <div class="col-md-12">
        				<label for="type_name">Message Type Name <span class="text-danger">*</span></label>
        				<input type="text" class="form-control" id="type_name" name="type_name" placeholder="Message Type Name" value="" data-required="true" onkeydown="return /[a-zA-Z ]/i.test(event.key) ">
        			</div>
                </div>
                <div class="row m-2">
